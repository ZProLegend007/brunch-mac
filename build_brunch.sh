...
ln -s kernel-chromebook-6.6 ./chroot/home/chronos/rootc/kernel || { echo "Failed to make the default kernel symlink"; exit 1; }
...
rm ../../home/chronos/kernel/lib/modules/*/source
